...
var testdataPath = gopathDir + "/src/github.com/bevisy/go2uml/testdata"
...
func Test_InterfacesSign(t *testing.T) {
	...
	assert.Equal(t, "github.com/bevisy/go2uml/testdata/a", interfaceMeta.PackagePath, "error in interfaceMeta")
	...
	assert.Equal(t, "github.com/bevisy/go2uml/testdata/a", structmeta.PackagePath, "error in structmeta")
...
func Test_complex(t *testing.T) {
	...
	interfaceMeta := analysisTool1.interfaceMetas[0]
	assert.Equal(t, "IA", interfaceMeta.Name)
	assert.Equal(t, "Add(github.com/bevisy/go2uml/testdata/b/sub.SubSA,sync.Locker,github.com/bevisy/go2uml/testdata/b.B,github.com/bevisy/go2uml/testdata/b/suba.SubSa1)", interfaceMeta.MethodSigns[0])
